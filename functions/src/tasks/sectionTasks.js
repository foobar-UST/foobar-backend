...
const deleteSectionResourcesTask = require('./section/deleteSectionResources');
...
exports.deleteSectionResources = functions.firestore
  .document(`${SELLERS_COLLECTION}/{sellerId}/${SELLER_SECTIONS_SUB_COLLECTION}/{sectionId}`)
  .onDelete(deleteSectionResourcesTask);